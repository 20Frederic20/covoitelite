    ...
    <div className="space-y-8">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground font-medium">Surveillez tous les trajets actifs et passés.</p>
        </div>
      </header>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="bg-card border border-border rounded-2xl py-3 pl-12 pr-4 text-sm focus:outline-none focus:border-primary transition-colors text-foreground appearance-none"
          />
          {dateFilter && (
            <button 
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-border">
                <th className="p-6 text-xs font-bold text-muted-foreground uppercase tracking-widest">Trajet</th>
                <th className="p-6 text-xs font-bold text-muted-foreground uppercase tracking-widest">Conducteur</th>
                <th className="p-6 text-xs font-bold text-muted-foreground uppercase tracking-widest">Places</th>
                <th className="p-6 text-xs font-bold text-muted-foreground uppercase tracking-widest">Prix</th>
                  ...
                  <tr key={r.id} className="hover:bg-muted/30 transition-colors group">
                    <td className="p-6">
                      <div className="flex items-center gap-4">
                        <div className="bg-muted p-2 rounded-xl text-primary group-hover:scale-110 transition-transform">
                          <Car size={20} />
                        </div>
                    ...
                    <td className="p-6">
                      <div className="flex items-center gap-3">
                        ...
                        <p className="font-bold text-sm text-foreground">{r.driverName}</p>
                      </div>
                    </td>
                    <td className="p-6">
